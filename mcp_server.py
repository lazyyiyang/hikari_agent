...
def fetch_company_data(
    ...
    report_type: Annotated[list[Literal["一季报", "中报", "三季报", "年报"]], Field(description="上市公司报告类型")],
) -> pd.DataFrame:
...
def data_analysis_coder(data: Annotated[pd.DataFrame, Field(description="上市公司报告数据")]) -> str:
